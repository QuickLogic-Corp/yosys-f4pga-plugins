...
struct QlSDPBramMergeWorker {
    ...
    QlSDPBramMergeWorker(RTLIL::Module *module) : module(module)
    {
        for (RTLIL::Cell *cell : module->selected_cells()) {
            if (cell->type != split_cell_type)
                continue;
            if (!cell->hasParam(ID(OPTION_SPLIT)))
                continue;
            if (cell->getParam(ID(OPTION_SPLIT)) != RTLIL::Const(1, 32))
                continue;
    ...
    {
        static const dict<RTLIL::IdString, RTLIL::IdString> bram1_map = {{ID(INIT), ID(INIT1)},
                                                                         {ID(PORT_W_WIDTH), ID(PORT_A1_WIDTH)},
                                                                         {ID(PORT_R_WIDTH), ID(PORT_B1_WIDTH)},
                                                                         {ID(PORT_W_WR_BE_WIDTH), ID(PORT_A1_WR_BE_WIDTH)}};
        static const dict<RTLIL::IdString, RTLIL::IdString> bram2_map = {{ID(INIT), ID(INIT2)},
    ...
    const dict<RTLIL::IdString, RTLIL::IdString> &port_map(bool second)
    {
        static const dict<RTLIL::IdString, RTLIL::IdString> bram1_map = {
          {ID(PORT_W_CLK), ID(PORT_A1_CLK)},     {ID(PORT_R_CLK), ID(PORT_B1_CLK)},         {ID(PORT_W_ADDR), ID(PORT_A1_ADDR)},
          {ID(PORT_R_ADDR), ID(PORT_B1_ADDR)},   {ID(PORT_W_WR_DATA), ID(PORT_A1_WR_DATA)}, {ID(PORT_W_WR_EN), ID(PORT_A1_WR_EN)},
          {ID(PORT_W_WR_BE), ID(PORT_A1_WR_BE)}, {ID(PORT_R_RD_EN), ID(PORT_B1_RD_EN)},     {ID(PORT_R_RD_DATA), ID(PORT_B1_RD_DATA)}};
        static const dict<RTLIL::IdString, RTLIL::IdString> bram2_map = {
          {ID(PORT_W_CLK), ID(PORT_A2_CLK)},     {ID(PORT_R_CLK), ID(PORT_B2_CLK)},         {ID(PORT_W_ADDR), ID(PORT_A2_ADDR)},
          {ID(PORT_R_ADDR), ID(PORT_B2_ADDR)},   {ID(PORT_W_WR_DATA), ID(PORT_A2_WR_DATA)}, {ID(PORT_W_WR_EN), ID(PORT_A2_WR_EN)},
          {ID(PORT_W_WR_BE), ID(PORT_A2_WR_BE)}, {ID(PORT_R_RD_EN), ID(PORT_B2_RD_EN)},     {ID(PORT_R_RD_DATA), ID(PORT_B2_RD_DATA)}};
...
struct QlSDPBramMergePass : public Pass {

    QlSDPBramMergePass() : Pass("ql_sdpbram_merge", "Infers QuickLogic k6n10f BRAM pairs that can operate independently") {}

    void help() override
    {
        //   |---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|
        log("\n");
        log("    ql_sdpbram_merge [selection]\n");
        log("\n");
    ...
    {
        log_header(design, "Executing QL_SDPBRAM_MERGE pass.\n");

        size_t argidx = 1;
        extra_args(args, argidx, design);

        for (RTLIL::Module *module : design->selected_modules()) {
            QlSDPBramMergeWorker worker(module);
...
struct QlTDPBramMergeWorker {
    ...
    QlTDPBramMergeWorker(RTLIL::Module *module) : module(module)
    {
        for (RTLIL::Cell *cell : module->selected_cells()) {
            if (cell->type != split_cell_type)
                continue;
    ...
    {
        static const dict<RTLIL::IdString, RTLIL::IdString> bram1_map = {
          {ID(PORT_A_CLK), ID(PORT_A1_CLK)},         {ID(PORT_B_CLK), ID(PORT_B1_CLK)},         {ID(PORT_A_CLK_EN), ID(PORT_A1_CLK_EN)},
          {ID(PORT_B_CLK_EN), ID(PORT_B1_CLK_EN)},   {ID(PORT_A_ADDR), ID(PORT_A1_ADDR)},       {ID(PORT_B_ADDR), ID(PORT_B1_ADDR)},
          {ID(PORT_A_WR_DATA), ID(PORT_A1_WR_DATA)}, {ID(PORT_B_WR_DATA), ID(PORT_B1_WR_DATA)}, {ID(PORT_A_WR_EN), ID(PORT_A1_WR_EN)},
          {ID(PORT_B_WR_EN), ID(PORT_B1_WR_EN)},     {ID(PORT_A_WR_BE), ID(PORT_A1_WR_BE)},     {ID(PORT_B_WR_BE), ID(PORT_B1_WR_BE)},
          {ID(PORT_A_RD_DATA), ID(PORT_A1_RD_DATA)}, {ID(PORT_B_RD_DATA), ID(PORT_B1_RD_DATA)}};
        static const dict<RTLIL::IdString, RTLIL::IdString> bram2_map = {
          {ID(PORT_A_CLK), ID(PORT_A2_CLK)},         {ID(PORT_B_CLK), ID(PORT_B2_CLK)},         {ID(PORT_A_CLK_EN), ID(PORT_A2_CLK_EN)},
          {ID(PORT_B_CLK_EN), ID(PORT_B2_CLK_EN)},   {ID(PORT_A_ADDR), ID(PORT_A2_ADDR)},       {ID(PORT_B_ADDR), ID(PORT_B2_ADDR)},
          {ID(PORT_A_WR_DATA), ID(PORT_A2_WR_DATA)}, {ID(PORT_B_WR_DATA), ID(PORT_B2_WR_DATA)}, {ID(PORT_A_WR_EN), ID(PORT_A2_WR_EN)},
          {ID(PORT_B_WR_EN), ID(PORT_B2_WR_EN)},     {ID(PORT_A_WR_BE), ID(PORT_A2_WR_BE)},     {ID(PORT_B_WR_BE), ID(PORT_B2_WR_BE)},
          {ID(PORT_A_RD_DATA), ID(PORT_A2_RD_DATA)}, {ID(PORT_B_RD_DATA), ID(PORT_B2_RD_DATA)}};
...
struct QlTDPBramMergePass : public Pass {

    QlTDPBramMergePass() : Pass("ql_tdpbram_merge", "Infers QuickLogic k6n10f BRAM pairs that can operate independently") {}

    void help() override
    {
        //   |---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|---v---|
        log("\n");
        log("    ql_tdpbram_merge [selection]\n");
        log("\n");
        log("    This pass identifies k6n10f 18K BRAM cells and packs pairs of them together\n");
        log("    into a TDP36K cell operating in split mode\n");
        log("\n");
    ...
    void execute(std::vector<std::string> args, RTLIL::Design *design) override
    {
        log_header(design, "Executing QL_TDPBRAM_MERGE pass.\n");

        size_t argidx = 1;
        extra_args(args, argidx, design);

        for (RTLIL::Module *module : design->selected_modules()) {
            QlTDPBramMergeWorker worker(module);
            worker.merge_bram_groups();
        }
    }
