...
yosys proc
equiv_opt -assert -async2sync -map +/quicklogic/qlf_k4n8/cells_sim.v synth_ql -family qlf_k4n8 -top my_dff
synth_ql -family qlf_k4n8 -top my_dff
design -load postopt
yosys cd my_dff
stat
...
# DFFR (posedge RST)
design -load read
synth_ql -family qlf_k4n8 -top my_dffr_p
yosys cd my_dffr_p
stat
select -assert-count 1 t:dffsr
...
# DFFR (posedge RST)
design -load read
synth_ql -family qlf_k4n8 -top my_dffr_p_2
...
# DFFR (negedge RST)
design -load read
synth_ql -family qlf_k4n8 -top my_dffr_n
yosys cd my_dffr_n
stat
select -assert-count 1 t:dffsr
...
# DFFS (posedge SET)
design -load read
synth_ql -family qlf_k4n8 -top my_dffs_p
yosys cd my_dffs_p
stat
select -assert-count 1 t:dffsr
select -assert-count 1 t:\$lut
...
# DFFS (negedge SET)
design -load read
synth_ql -family qlf_k4n8 -top my_dffs_n
yosys cd my_dffs_n
stat
select -assert-count 1 t:dffsr
...
# DFFN
design -load read
synth_ql -family qlf_k4n8 -top my_dffn
yosys cd my_dffn
stat
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffnr_p
yosys cd my_dffnr_p
stat
select -assert-count 1 t:dffnsr
select -assert-count 1 t:\$lut
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffnr_n
yosys cd my_dffnr_n
stat
select -assert-count 1 t:dffnsr
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffns_p
yosys cd my_dffns_p
stat
select -assert-count 1 t:dffnsr
select -assert-count 1 t:\$lut
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffns_n
yosys cd my_dffns_n
stat
select -assert-count 1 t:dffnsr
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_ppp
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_pnp
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_ppn
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_pnn
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_npp
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_nnp
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_npn
...
design -load read
synth_ql -family qlf_k4n8 -top my_dffsr_nnn
...
hierarchy -top my_dff
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_dff
design -load postopt
yosys cd my_dff
stat
...
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_dffe
design -load postopt
yosys cd my_dffe
stat
select -assert-count 1 t:dffepc
...
hierarchy -top my_dffr_p
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_dffr_p
design -load postopt
yosys cd my_dffr_p
stat
select -assert-count 1 t:dffepc
...
hierarchy -top my_dffr_n
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_dffr_n
design -load postopt
yosys cd my_dffr_n
stat
...
hierarchy -top my_sdffs_p
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_sdffs_p
design -load postopt
yosys cd my_sdffs_p
stat
...
hierarchy -top my_sdffns_p
yosys proc
equiv_opt -async2sync -assert -map +/quicklogic/pp3/cells_sim.v synth_ql -family pp3 -top my_sdffns_p
design -load postopt
yosys cd my_sdffns_p
stat
select -assert-count 1 t:LUT1
