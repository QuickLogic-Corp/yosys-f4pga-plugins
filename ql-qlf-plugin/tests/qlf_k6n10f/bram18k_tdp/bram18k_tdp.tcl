...
select *
synth_ql -family qlf_k6n10f -top dpram_18x1024_x2 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top dpram_9x2048_x2 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top dpram_18x1024_9x2048 -bram_types
opt_expr -undriven
opt_clean
stat
