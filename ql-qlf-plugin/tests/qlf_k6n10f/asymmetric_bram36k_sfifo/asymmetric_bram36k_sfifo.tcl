...
select *
synth_ql -family qlf_k6n10f -top f4096x9_1024x36 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top f2048x18_1024x36 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top f2048x18_4098x9 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top f1024x36_2048x18 -bram_types
opt_expr -undriven
opt_clean
stat
