...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_36x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_32x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_18x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_16x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_9x4096 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_8x4096 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_4x8192 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_2x16384 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_1x32768 -bram_types
opt_expr -undriven
opt_clean
stat
