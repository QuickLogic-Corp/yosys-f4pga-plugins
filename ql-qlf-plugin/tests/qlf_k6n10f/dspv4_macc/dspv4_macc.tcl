# dspv4_macc -- DSP-V4 inference (ql_dspv4).
#
...
read_verilog dspv4_macc.v
hierarchy -top dspv4_macc
$PASS_NAME -family qlf_k6n10f -top dspv4_macc -dspv4 -no_abc9 -lib_path $LIB/
