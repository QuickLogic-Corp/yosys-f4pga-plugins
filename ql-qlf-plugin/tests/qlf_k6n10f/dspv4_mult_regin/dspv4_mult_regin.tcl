...
#
# Each bank is ONE wide cell, not one cell per bit: the width is carried in the
# name. A2 is 32 wide because the A port is -- the operand's sign extension is
...
select -assert-count 1 t:QL_DSP4_B1_DFFRE_18
