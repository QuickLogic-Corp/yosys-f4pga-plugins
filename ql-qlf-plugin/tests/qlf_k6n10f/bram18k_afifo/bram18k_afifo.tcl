...
select *
synth_ql -family qlf_k6n10f -top af1024x18_1024x18 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top af1024x16_1024x16 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top af2048x9_2048x9 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top af2048x8_2048x8 -bram_types
opt_expr -undriven
opt_clean
stat
