...
select *
synth_ql -family qlf_k6n10f -top spram_36x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top spram_32x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top spram_18x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top spram_16x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select spram_9x4096
select *
synth_ql -family qlf_k6n10f -top spram_9x4096 -bram_types
opt_expr -undriven
opt_clean
stat
...
select spram_8x4096
select *
synth_ql -family qlf_k6n10f -top spram_8x4096 -bram_types
opt_expr -undriven
opt_clean
stat
