# dspv4_mult_sub -- DSP-V4 inference (ql_dspv4).
#
...
read_verilog dspv4_mult_sub.v
hierarchy -top dspv4_mult_sub
$PASS_NAME -family qlf_k6n10f -top dspv4_mult_sub -dspv4 -no_abc9 -lib_path $LIB/

yosys cd dspv4_mult_sub
# The DSP was used.
