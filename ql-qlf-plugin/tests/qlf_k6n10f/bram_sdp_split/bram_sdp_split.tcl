...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x18x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x16x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x9x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x8x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x4x4096 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x2x8192 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top BRAM_SDP_SPLIT_2x1x16384 -bram_types
opt_expr -undriven
opt_clean
stat
