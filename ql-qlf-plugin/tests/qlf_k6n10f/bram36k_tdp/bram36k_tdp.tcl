...
select *
synth_ql -family qlf_k6n10f -top dpram_36x1024 -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top dpram_18x2048 -bram_types
opt_expr -undriven
opt_clean
stat
...
select dpram_9x4096
select *
synth_ql -family qlf_k6n10f -top dpram_9x4096 -bram_types
opt_expr -undriven
opt_clean
stat
