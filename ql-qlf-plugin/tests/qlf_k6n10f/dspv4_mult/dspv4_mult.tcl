# dspv4_mult -- DSP-V4 inference (ql_dspv4).
#
...
read_verilog dspv4_mult.v
hierarchy -top dspv4_mult
$PASS_NAME -family qlf_k6n10f -top dspv4_mult -dspv4 -no_abc9 -lib_path $LIB/
