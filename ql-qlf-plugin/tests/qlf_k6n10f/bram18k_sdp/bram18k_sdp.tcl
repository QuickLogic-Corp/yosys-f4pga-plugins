...
select *
synth_ql -family qlf_k6n10f -top spram_18x1024_2x -bram_types
opt_expr -undriven
opt_clean
stat
...
select *
synth_ql -family qlf_k6n10f -top spram_9x2048_x2 -bram_types
opt_expr -undriven
opt_clean
stat
...
select -assert-count 1 t:TDP36K_BRAM_A1_X9_B1_X9_A2_X18_B2_X18_split 