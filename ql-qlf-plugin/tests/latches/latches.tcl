...
## in synth_ql for that family
## LATCHP
#synth_ql -family qlf_k4n8 -top latchp
#yosys cd latchp
#stat
...
## LATCHP no init
#design -load read
#synth_ql -family qlf_k4n8 -top latchp_noinit
...
synth_ql -family pp3 -top latchp_noinit
yosys cd latchp_noinit
...
yosys proc
# Can't run any sort of equivalence check because latches are blown to LUTs
synth_ql -family pp3 -top latchn
yosys cd latchn
select -assert-count 1 t:LUT3
select -assert-count 3 t:inpad
select -assert-count 1 t:outpad
...
yosys proc
# Can't run any sort of equivalence check because latches are blown to LUTs
synth_ql -family pp3 -top my_latchsre
yosys cd my_latchsre
