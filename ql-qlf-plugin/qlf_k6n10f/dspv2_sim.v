...
// =============================================================================
// QL_DSPV2 behavioural simulation model -- semantic lock-ins (W1.10)
// =============================================================================
// This file is the executable spec for the dspv2 hard cell. The Yosys-driven
// dspv2 lowering flow uses it as the gold reference for equiv_induct (see
// tests/qlf_k6n10f/dspv2/dspv2_equiv.tcl, W1.6). Anything written here is
...
//   a stale spec slide. v1 silicon and the v2 RTL have always been
//   active-high. Wave 4 will refresh the spec deck to match.
//
// acc_reset (Q2)
...
//   `b + c` pattern that the user expected to wrap; the W1.7-W1.9 smokes
//   currently route b through plain wires with c tied to 0 to avoid
//   exercising this path.
//
// Out_sel encoding aliases (Q4, W1.1)
...
//   for hand-written instantiations to remain accepted. W1.1 corrected
//   the inference to emit 100 (was 010 -- combinational, which silently
//   dropped the user-visible output FF).
// =============================================================================
